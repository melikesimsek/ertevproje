<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="eguncelle.aspx.cs" Inherits="ertevproje.eguncelle" %>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Eğitim Güncelle</h4>
                    </div>
                  ...
                  <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="DropDownList3" runat="server">
                                ...
                                <asp:ListItem Value="02">PLC Sistemleri</asp:ListItem>
                                <asp:ListItem Value="03">Web Tasarımı</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                     <div class="col-md-7">
                   ...
                   <asp:TextBox ID="TextBox7" class="form-control p-4" required="required" runat="server" TextMode="SingleLine"></asp:TextBox>
                   </div>
                 </div>
                 <div class="col-md-7">
                        <div class="form-group">
