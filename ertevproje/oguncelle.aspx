<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="oguncelle.aspx.cs" Inherits="ertevproje.oguncelle" %>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Öğrenci Güncelle</h4>
                    </div>
                <div class="form-row mt-3">
                    <div class="col-md-7">
                        <div class="form-group">
                            <asp:Label ID="Label4" runat="server" Text="Öğrenci No"></asp:Label>
                            <asp:TextBox ID="TextBox7" type="text" class="form-control p-4" placeholder="Öğrenci No" required="required" runat="server"></asp:TextBox>
                        </div>
                    <div class="col-md-7">
                        <div class="form-group">
                            <asp:Label ID="Label9" runat="server" Text="Ad"></asp:Label>
                            <asp:TextBox ID="TextBox1" type="text" class="form-control p-4" placeholder="Öğrenci Ad" required="required" runat="server"></asp:TextBox>
                        </div>
                    </div>
                  <div class="col-md-7">
                        <div class="form-group">
                            <asp:Label ID="Label8" runat="server" Text="Soyad"></asp:Label>
                            <asp:TextBox ID="TextBox2" type="text" class="form-control p-4" placeholder="Öğrenci Soyad" required="required" runat="server"></asp:TextBox>
                        </div>
                    </div>
                      <div class="col-md-7">
                 ...
                 <div class="col-md-7">
                       ...
                       <div class="col-md-7">
                        <div class="form-group">
                           <asp:Label ID="Label10" runat="server" Text="Katıldığı Eğitim"></asp:Label>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ertevegitimvt %>" SelectCommand="SELECT [kurs_adi], [kurs_no] FROM [kurslar]"></asp:SqlDataSource>
                        </div>
                    </div>
