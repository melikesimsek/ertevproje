<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="pekle.aspx.cs" Inherits="ertevproje.pekle" %>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Personel Ekle</h4>
                    </div>
                <div class="form-row mt-3">
                 ...
                 <div class="col-md-7">
                   ...
                   <asp:TextBox ID="TextBox7" class="form-control p-4" required="required" runat="server" TextMode="Date"></asp:TextBox>
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                               <asp:Label ID="Label12" runat="server" Text="Çalıştığı Birim"></asp:Label>
                            <asp:TextBox ID="TextBox10" type="text" class="form-control p-4" placeholder="Birim" TextMode="SingleLine" required="required" runat="server"></asp:TextBox>
                        </div>
                    </div>
                     <div class="col-md-7">
                        <div class="form-group">
                               <asp:Label ID="Label11" runat="server" Text="Fotoğraf"></asp:Label>
                            <asp:TextBox ID="TextBox9" type="text" class="form-control p-4" placeholder="avatar" TextMode="SingleLine" required="required" runat="server"></asp:TextBox>
                        </div>
                    </div>
